<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:78:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/admin/view/log/lst.html";i:1573002353;s:71:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/top.html";i:1573002353;s:72:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/left.html";i:1573175989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">日志列表</a></li>
      </ul>
    </div>
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="<?php echo url('log/detail',['log_id'=>$vo['log_id']]); ?>"><?php echo $vo['log_title']; ?></a></td>
                  ...
                  <td><a href="<?php echo url('log/checkstatus',['log_id'=>$vo['log_id']]); ?>"><button
