<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/admin/view/activity/add.html";i:1573002354;s:71:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/top.html";i:1573002353;s:72:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/left.html";i:1573175989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-edit"></i>添加活动</h1>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="tile">
          <h3 class="tile-title">请添加活动信息</h3>
          <div class="tile-body">
            <form class="form-horizontal" enctype="multipart/form-data" action="" method="post">
              <div class="form-group">
                <label class="control-label">活动名称</label>
                <input class="form-control" name="activity_name" type="text" placeholder="请输入活动名称">
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                ...
                <textarea class="form-control" rows="4" name="activity_desc" placeholder="请输入活动简介"></textarea>
              </div>
              <div class="form-group">
                <label class="control-label">活动开始时间</label>
                <input class="form-control" type="datetime-local" name="activity_startime" placeholder="请输入活动开始时间">
              </div>
              <div class="form-group">
                <label class="control-label">活动结束时间</label>
                <input class="form-control" type="datetime-local" name="activity_endtime" placeholder="请输入活动结束时间">
              </div>
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  ...
                  <select class="form-control" id="activity_score" name="activity_score"
                    ...
                    <select>
                      </span><input name="user_hair" type="hidden" />
                </div>
              </div>
          </div>
        ...
        <div class="tile-footer">
          <button class="btn btn-primary" type="submit"><i
              class="fa fa-fw fa-lg fa-check-circle"></i>添加</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary"
            href="<?php echo url('activity/lst'); ?>"><i class="fa fa-fw fa-lg fa-times-circle"></i>取消</a>
        </div>
      </div>
    </div>
    </div>
