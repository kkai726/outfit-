<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/admin/view/classify/add.html";i:1573002353;s:71:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/top.html";i:1573002353;s:72:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/left.html";i:1573175989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-edit"></i>添加穿搭分类</h1>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="tile">
          <h3 class="tile-title">请添加穿搭分类</h3>
          <div class="tile-body">
            <form class="form-horizontal" enctype="multipart/form-data" action="" method="post">
              <div class="form-group">
                <label class="control-label">分类名称</label>
                <input class="form-control" name="classify_tag" type="text" placeholder="请输入分类名称">
              </div>
