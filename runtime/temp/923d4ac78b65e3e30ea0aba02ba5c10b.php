<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/admin/view/log/detail.html";i:1573002353;s:71:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/top.html";i:1573002353;s:72:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/left.html";i:1573175989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-edit"></i>日志详情</h1>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="tile">
          <h3 class="tile-title">当前日志详情</h3>
          <div class="tile-body">
            <form>
              <div class="form-group">
                <?php if(is_array($dai) || $dai instanceof \think\Collection || $dai instanceof \think\Paginator): $i = 0; $__LIST__ = $dai;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <label class="control-label">
                  <h5>日志名称:</h5>
                </label><br>
                <td><?php echo $vo['log_title']; ?></td>
              </div>
              <div class="form-group">
                <label class="control-label">
                  <h5>日志详情:</h5>
                </label><br>
                <td><?php echo $vo['log_desc']; ?></td>
              </div>
              <div class="form-group">
                <label class="control-label">
                  <h5>发布时间:</h5>
                </label><br>
                <td><?php echo $vo['log_pubtime']; ?></td>
              </div>
              <div class="form-group">
                <label class="control-label">
                  <h5>更新时间:</h5>
                </label><br>
                <td><?php echo $vo['log_update']; ?></td>
              </div>
              <div class="form-group">
                <label class="control-label">
                  <h5>上传者:</h5>
              ...
              <div class="form-group">
                ...
                <?php if($vo['log_status']==0): ?>
                <td>有效</td>
                <?php elseif($vo['log_status']==1): ?>
                <td>已冻结</td>
                <?php endif; ?>
              </div>
