<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:82:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/index/view/index/index.html";i:1573023004;s:65:"/www/wwwroot/htk.iy3u6.cn/outfit/application/index/view/base.html";i:1573002349;s:74:"/www/wwwroot/htk.iy3u6.cn/outfit/application/index/view/common/header.html";i:1573004003;s:74:"/www/wwwroot/htk.iy3u6.cn/outfit/application/index/view/common/footer.html";i:1573002350;}*/ ?>
<!doctype html>
			...
			<div class="container">
				<div class="hero-area-inner">
					...
					<div class="hero-area-image">
						<img src="http://htk.iy3u6.cn/outfit/public/static/user/docs/img/slider/slider-image-1.png" alt="man mask">
					</div>
...
<main class="page-content">
	...
	<div class="cr-section services-area section-padding-bottom-lg bg-white">
				...
				<div class="col-lg-4 col-md-6 col-12 portfolio-item portfolio-filter-graphic portfolio-filter-design">
					<div class="portfolio">
						...
						<div class="portfolio-image">
							...
							<img src="http://htk.iy3u6.cn/outfit/public/static/images/<?php echo $vo['pic']; ?>" alt="portfolio image" height="500px" width="450px">
							<?php elseif($type[$i-1] == 'mp4'|'avi'): ?>
							<video src="http://htk.iy3u6.cn/outfit/public/static/images/<?php echo $vo['pic']; ?>" controls="controls" width="375px" height="491.11px">
							<?php endif; ?>
						</div>
						<?php if($type[$i-1] == 'jpg'|'png'|'gif'): ?>
						<div class="portfolio-content">
							<a href="http://htk.iy3u6.cn/outfit/public/static/images/<?php echo $vo['pic']; ?>" class="portfolio-zoom-button"></a>
		...
		<!-- <p style="text-align: center"><img style="margin-top: 100px" src="http://htk.iy3u6.cn/outfit/public/static/user/docs/photo/6.jpg" width="70px" height="50px"></p> -->
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="service text-center">
						<div  class="pp">
							...
							<img src="http://htk.iy3u6.cn/outfit/public/static/images/<?php echo $vo['user_pic']; ?>"  width="300px" height="300px"></a>
						</div>
	...
	<div class="cr-section services-area section-padding-bottom-lg bg-white">
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-4 col-md-6 col-12">
					<div class="service text-center">
						<img src="http://htk.iy3u6.cn/outfit/public/static/images/<?php echo $vo['activity_post']; ?>" width="300px" height="300px">
