<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:68:"F:\wamp\www\outfit\public/../application/admin\view\comment\lst.html";i:1573176363;s:57:"F:\wamp\www\outfit\application\admin\view\commom\top.html";i:1572580306;s:58:"F:\wamp\www\outfit\application\admin\view\commom\left.html";i:1573176193;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="#">评论列表</a></li>
        </ul>
      </div>
    <div  class="kk">
      <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <!-- <td><img src="http://127.0.0.1/outfit/public/static/images/<?php echo $vo['pic']; ?>" style="width:130px;height:80px;margin: 10px;margin-left: 30px"></td> -->
            ...
            <div class="tile-body">
              <table class="table table-hover table-bordered" id="sampleTable">
                ...
                <tbody>
                  ...
                  <tr>
                    <td><?php echo $i; ?></td>
                    <td><a href="<?php echo url('user/detail',['user_id'=>$vo['user_id']]); ?>"><?php echo $vo['user_name']; ?></a></td>
                    <td><?php echo $vo['comment_time']; ?></td>
                    <td><?php echo $vo['comment_desc']; ?></td>
                    <td><a href="<?php echo url('picture/detail',['pic_id'=>$vo['pic_id']]); ?>">
                      <?php if($type[$i-1] == 'jpg'|'png'|'gif'): ?>
                    <img src="http://127.0.0.1/outfit/public/static/images/<?php echo $vo['pic']; ?>"
                        style="width:130px;height:80px;margin: 10px;margin-left: 30px">
                        <?php elseif($type[$i-1] == 'mp4'|'avi'): ?>
                        <video src="http://127.0.0.1/outfit/public/static/images/<?php echo $vo['pic']; ?>"
                        style="width:130px;height:80px;margin: 10px;margin-left: 30px">
                        <?php endif; ?>
                      <!-- <img src="http://127.0.0.1/outfit/public/static/images/<?php echo $vo['pic']; ?>" style="width:130px;height:80px;margin: 10px;margin-left: 30px"> -->
                    </a></td>
                    <?php if($vo['comment_status']==0): ?>
                    <td style="text-align: center"><button class="btn btn-outline-success" type="button">有效</button></td>
                    <td><a href="<?php echo url('cmodify',['comment_id'=>$vo['comment_id']]); ?>"><button class="btn btn-outline-warning">禁用</button></a></td>
                    <?php else: ?>
                    <td style="text-align: center"><button  class="btn btn-outline-danger" type="button">无效</button></td>
                    <td><a href="<?php echo url('cmodify',['comment_id'=>$vo['comment_id']]); ?>"><button class="btn btn-outline-warning">解除禁用</button></a></td>
                    <?php endif; ?>
                  </tr>
                  <?php endforeach; endif; else: echo "" ;endif; ?>
