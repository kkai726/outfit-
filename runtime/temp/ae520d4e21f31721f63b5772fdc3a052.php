<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:81:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/index/view/follow/lst.html";i:1573002350;s:65:"/www/wwwroot/htk.iy3u6.cn/outfit/application/index/view/base.html";i:1573002349;s:74:"/www/wwwroot/htk.iy3u6.cn/outfit/application/index/view/common/header.html";i:1573004003;s:74:"/www/wwwroot/htk.iy3u6.cn/outfit/application/index/view/common/footer.html";i:1573002350;}*/ ?>
<!doctype html>
<html class="no-js" lang="zxx">
<head>
    <meta charset="utf-8">
    <meta http-equiv="x-ua-compatible" content="ie=edge">
    <title>Outfit粉丝</title>
...
<!--<div id="user_sub">-->
    <!--<?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-->
    <!--<div class="image">-->
        <!--<p class="img"><img src="http://htk.iy3u6.cn/outfit/public/static/user/docs/photo/<?php echo $vo['user_pic']; ?>" width="148" height="148"></p>-->
    <!--</div>-->
    <!--<div class="btn_follow">-->
        <!--<p class="btn"><a href="" class="icon_font over"><span class="txt"><?php echo $vo['user_name']; ?></span></a></p>-->
    <!--</div>-->
    <!--<?php endforeach; endif; else: echo "" ;endif; ?>-->
<!--</div>-->
