<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/admin/view/activity/lst.html";i:1573002354;s:71:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/top.html";i:1573002353;s:72:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/left.html";i:1573175989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">活动列表</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
        <div class="add"><button class="btn btn-warning" type="button"><a href="<?php echo url('activity/add'); ?>">+
              Add</a></button></div>
        <div class="tile">
          <div class="tile-body">
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><a href="<?php echo url('activity/detail',['activity_id'=>$vo['activity_id']]); ?>"><?php echo $vo['activity_name']; ?></a></td>
                  <td><img src="http://htk.iy3u6.cn/outfit/public/static/images/<?php echo $vo['activity_post']; ?>" style="width:150px;height:100px"></td>
                  <td><?php echo $vo['activity_startime']; ?></td>
                  <td><?php echo $vo['admin_name']; ?></td>
                  <td><?php echo $vo['activity_score']; ?></td>
                  <?php if($vo['activity_status']==0): ?>
                  <td><a href="<?php echo url('activity/del',['activity_id'=>$vo['activity_id']]); ?>">删除</a>|<a
                      href="<?php echo url('activity/edit',['activity_id'=>$vo['activity_id']]); ?>">编辑</a>
                    <p><a
                        href="<?php echo url('activity/checkstatus',['activity_id'=>$vo['activity_id']]); ?>"><button>一键发布</button></a>
                    </p>
                  </td>
                  <?php elseif($vo['activity_status']==1): ?>
                  <td><a href="<?php echo url('activity/del',['activity_id'=>$vo['activity_id']]); ?>">删除</a>|<a
                      href="<?php echo url('activity/edit',['activity_id'=>$vo['activity_id']]); ?>">编辑</a>
                    <p>活动进行中</p>
                    <p><a
                        href="<?php echo url('activity/checkstatus',['activity_id'=>$vo['activity_id']]); ?>"><button>截止活动</button></a>
                    </p>
                  </td>
