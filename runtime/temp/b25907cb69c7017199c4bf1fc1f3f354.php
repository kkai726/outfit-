<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/admin/view/getmoney/lst.html";i:1573002353;s:71:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/top.html";i:1573002353;s:72:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/left.html";i:1573175989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-dashboard"></i> 欢迎超级系统管理员</h1>
        <p>Welcome Super System Administrator</p>
      </div>
      <ul class="app-breadcrumb breadcrumb">
        <li class="breadcrumb-item"><i class="fa fa-home fa-lg"></i></li>
        <li class="breadcrumb-item"><a href="#">申请提现</a></li>
      </ul>
    </div>
    <div class="kk">
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                <tr>
                  ...
                  <?php if($vo['user_st']==1||$vo['user_st']==3): ?>
                  <td style="text-align: center">
                    <a href="#"><button class="btn btn-outline-success" style="color: #ffc107; border-color: #ffc107;"
                        type="button">申请中</button></a>
                  </td>
                  <td><a href="<?php echo url('setemail',['user_id'=>$vo['user_id']]); ?>">
                      <button class="btn btn-outline-warning press"
                        style="color:plum; border-color: plum; ">发送邮件</button></a>
                    <a href="<?php echo url('setmoney',['user_id'=>$vo['user_id']]); ?>">
                      <button class="btn btn-outline-warning"
                        style="color: lightskyblue; border-color: lightskyblue; margin-left: 5%;">通过</button></a>
                  </td>
                  <?php elseif($vo['user_st']==2): ?>
                  <td style="text-align: center">
                    <button class="btn btn-outline-success" type="button">已通过</button></td>
                  <td></td>
