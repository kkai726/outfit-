<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:89:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/admin/view/classify/rebacklst.html";i:1573002354;s:71:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/top.html";i:1573002353;s:72:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/left.html";i:1573175989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="add"><button class="btn btn-warning" type="button"><a href="<?php echo url('classify/lst'); ?>">re
              List</a></button></div>
        <div class="tile">
          <div class="tile-body">
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                <?php if(is_array($crst) || $crst instanceof \think\Collection || $crst instanceof \think\Paginator): $i = 0; $__LIST__ = $crst;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $vo['classify_tag']; ?></td>
                  <td><a href="<?php echo url('classify/doreback',['classify_id'=>$vo['classify_id']]); ?>">恢复</a>
                </tr>
