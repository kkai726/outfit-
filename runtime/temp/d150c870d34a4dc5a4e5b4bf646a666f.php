<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/admin/view/classify/edit.html";i:1573002354;s:71:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/top.html";i:1573002353;s:72:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/left.html";i:1573175989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    <div class="app-title">
      <div>
        <h1><i class="fa fa-edit"></i>修改穿搭分类</h1>
      </div>
    ...
    <div class="row">
      <div class="col-md-6">
        <div class="tile">
          <h3 class="tile-title">请修改穿搭分类</h3>
          <div class="tile-body">
            <form class="form-horizontal" enctype="multipart/form-data" action="<?php echo url('classify/doedit'); ?>"
              method="post">
              <div class="form-group">
                <label class="control-label">分类名称</label>
                <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <input type="hidden" name="classify_id" value="<?php echo $vo['classify_id']; ?>">
                <input class="form-control" name="classify_tag" value="<?php echo $vo['classify_tag']; ?>" type="text"
                  placeholder="请输入分类名称">
        ...
        <div class="tile-footer">
          <button class="btn btn-primary" type="submit"><i
              class="fa fa-fw fa-lg fa-check-circle"></i>修改</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-secondary"
            href="<?php echo url('classify/lst'); ?>"><i class="fa fa-fw fa-lg fa-times-circle"></i>取消</a>
        </div>
      </div>
    </div>
    </div>
