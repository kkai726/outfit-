<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:84:"/www/wwwroot/htk.iy3u6.cn/outfit/public/../application/admin/view/superuser/lst.html";i:1573002353;s:71:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/top.html";i:1573002353;s:72:"/www/wwwroot/htk.iy3u6.cn/outfit/application/admin/view/commom/left.html";i:1573175989;}*/ ?>
<!DOCTYPE html>
<html lang="en">
  ...
  <main class="app-content">
    <div class="app-title">
      ...
      <ul class="app-breadcrumb breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="#">达人列表</a></li>
      </ul>
    </div>
    <div class="row">
      <div class="col-md-12">
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>已冻结</td><?php elseif($vo['user_status']==2): ?>
                  <td>申请达人中</td>
                  <?php endif; ?>
                  <td><img src="http://htk.iy3u6.cn/outfit/public/static/images/<?php echo $vo['user_pic']; ?>" style="width:50px;height:40px"></td>
                  <td><?php echo $vo['user_email']; ?></td>
                  <td><?php echo $vo['user_score']; ?></td>
                  <?php if($vo['user_status']==2): ?>
                  <td style="text-align: center"><button class="btn btn-outline-success" type="button">申请中</button></td>
                  <td><a href="<?php echo url('checkstatusr',['user_id'=>$vo['user_id']]); ?>"><button
                        class="btn btn-outline-warning">通过</button></a>
                    <p><a href="<?php echo url('checkstatusl',['user_id'=>$vo['user_id']]); ?>"><button class="btn btn-outline-warning"
                          style="margin-top: 20px;">不通过</button></a></p>
                  </td>
                  <?php endif; ?>
                </tr>
  ...
  <div class="modal fade" id="myModal" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <h2 class="modal-body" style="margin-left: 100px">确认要修改状态吗？</h2>

        <div class="modal-footer">
          <form class="form-horizontal" method="POST" action="" enctype="multipart/form-data">
            <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
            <input type="submit" class="btn btn-warning btn-ok" value="确认修改">
          </form>
        </div>
      </div>
    </div>
