<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:72:"F:\wamp\www\outfit\public/../application/admin\view\picture\comment.html";i:1573032105;s:57:"F:\wamp\www\outfit\application\admin\view\commom\top.html";i:1572580306;s:58:"F:\wamp\www\outfit\application\admin\view\commom\left.html";i:1573176193;}*/ ?>
<!DOCTYPE html>
<html lang="en">
...
<body class="app sidebar-mini rtl">
  ...
  <main class="app-content">
    ...
    <div class="kk">
      <?php if(is_array($info) || $info instanceof \think\Collection || $info instanceof \think\Paginator): $i = 0;$__LIST__ = is_array($info) ? array_slice($info,0,1, true) : $info->slice(0,1, true); if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
      <td>
        <?php if($type[$i-1] == 'jpg'|'png'|'gif'): ?>
                  <img src="http://127.0.0.1/outfit/public/static/images/<?php echo $vo['pic']; ?>" style="width:150px;height:100px">
                  <?php elseif($type[$i-1] == 'mp4'|'avi'): ?>
                  <video src="http://127.0.0.1/outfit/public/static/images/<?php echo $vo['pic']; ?>" controls="controls" style="width:150px;height:100px">
                  <?php endif; ?>
      </td>
            ...
            <table class="table table-hover table-bordered" id="sampleTable">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><a href="<?php echo url('cmodify',['comment_id'=>$vo['comment_id']]); ?>"><button
